              ...
              .map((student, index) => (
                <div key={student.id} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs theme-text-muted">{student.averageScore}% avg score</p>
                  </div>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm theme-text-muted">Passed Assessments</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm theme-text-muted">Failed Assessments</p>
            </div>
          </div>
        </Card>
