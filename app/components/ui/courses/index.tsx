      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col mt-20 items-center justify-center max-w-[950px] w-full px-5">
            ...
            />
            <a
              className={`w-full h-[60px] bg-[#39BEAE] text-white py-3 rounded-lg text-md text-center mt-5 text-[20px] mb-5 hover:text-gray-700 transition-colors ${
                isDark ? "text-white" : "text-black"
              }`}
              href="/courses"
            >
              Lesson I - 50% Complete
            </a>
            <a
              className={`w-full h-[60px] bg-[#D9D9D9] text-black py-3 rounded-lg text-md text-center mt-5 text-[20px] mb-5 hover:text-gray-700 hover:bg-[#39BEAE] hover:text-white transition-colors ${
